...
var map = __webpack_require__(70316);
...
function clone(value) {
  return (0,_baseClone/* default */.c)(value, CLONE_SYMBOLS_FLAG);
}
...
function write(g) {
  ...
  if (!isUndefined/* default */.c(g.graph())) {
...
function writeNodes(g) {
  return map/* default */.c(g.nodes(), function (v) {
    var nodeValue = g.node(v);
    var parent = g.parent(v);
    var node = { v: v };
    if (!isUndefined/* default */.c(nodeValue)) {
...
function writeEdges(g) {
  return map/* default */.c(g.edges(), function (e) {
    var edgeValue = g.edge(e);
    var edge = { v: e.v, w: e.w };
    if (!isUndefined/* default */.c(e.name)) {
      edge.name = e.name;
    }
    if (!isUndefined/* default */.c(edgeValue)) {
...
// EXTERNAL MODULE: ./node_modules/mermaid/dist/mermaid-04fb0060.js + 3 modules
var mermaid_04fb0060 = __webpack_require__(94184);
...
/* harmony export */ });
/* harmony import */ var _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(94184);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(91292);
/* harmony import */ var _createText_a48a4c90_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(16496);
...
/* harmony export */ });
/* harmony import */ var _flowDb_f4777d50_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(72432);
/* harmony import */ var _styles_b39df0e1_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(80392);
/* harmony import */ var _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(94184);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(91292);
...
/* harmony import */ var dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(58408);
...
/* harmony import */ var dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(58408);
/* harmony import */ var _edges_5ec2587c_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(86836);
/* harmony import */ var _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(94184);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(95536);
/* harmony import */ var _createText_a48a4c90_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(16496);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(91292);
...
const adjustClustersAndEdges = (graph, depth) => {
  ...
  _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Adjusted Graph", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph));
  extractor(graph, 0);
  _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.l.trace(clusterDb);
};
const extractor = (graph, depth) => {
  _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("extractor - ", depth, dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph), graph.children("D"));
  if (depth > 10) {
  ...
  for (const node of nodes) {
    ...
    graph.children(node) && graph.children(node).length > 0) {
      ...
      _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Old graph before copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph));
      ...
      _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("New graph after copy node: (", node, ")", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(clusterGraph));
      _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Old graph after copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph));
    } else {
      _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.l.warn(
        "Cluster ** ",
        node,
...
const recursiveRender = async (_elem, graph, diagramtype, id, parentCluster) => {
  _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph in recursive render: XXX", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph), parentCluster);
  ...
  _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph after layout:", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph));
  let diff = 0;
...
const render = async (elem, graph, markers, diagramtype, id) => {
  ...
  clear();
  clear$1();
  _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph at first:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph)));
  adjustClustersAndEdges(graph);
  _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph after:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph)));
...
// EXTERNAL MODULE: ./node_modules/dagre-d3-es/src/graphlib/index.js
var graphlib = __webpack_require__(95536);
// EXTERNAL MODULE: ./node_modules/d3/src/index.js + 208 modules
var src = __webpack_require__(91292);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/mermaid-04fb0060.js + 3 modules
var mermaid_04fb0060 = __webpack_require__(94184);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/index-0980fb80.js
var index_0980fb80 = __webpack_require__(23104);
...
const channel = (color, channel) => {
    return utils/* default */.c.lang.round(dist_color/* default */.c.parse(color)[channel]);
};
/* EXPORT */
/* harmony default export */ const methods_channel = (channel);

// EXTERNAL MODULE: ./node_modules/khroma/dist/methods/rgba.js
var rgba = __webpack_require__(19837);
...
const addEdges = function(edges, g, diagObj) {
  ...
  edges.forEach(function(edge) {
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,mermaid_04fb0060.n)(edge.interpolate, src/* curveLinear */.qGi);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,mermaid_04fb0060.n)(edges.defaultInterpolate, src/* curveLinear */.qGi);
    } else {
      edgeData.curve = (0,mermaid_04fb0060.n)(conf.curve, src/* curveLinear */.qGi);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
...
const draw = async function(text, id, _version, diagObj) {
  ...
  keys.forEach(function(key) {
    ...
    if (vertex.link) {
      const node = (0,src/* select */.MlD)("#" + id + ' [id="' + key + '"]');
      if (node) {
...
const fade = (color, opacity) => {
  ...
  return rgba/* default */.c(r, g, b, opacity);
};
