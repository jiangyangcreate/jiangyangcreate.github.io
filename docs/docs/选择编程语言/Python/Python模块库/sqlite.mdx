...
- <Highlight color="green">[SQLite 官方文档](https://www.sqlite.org/docs.html) - 权威参考</Highlight>
- <Highlight color="green">[Python sqlite3 文档](https://docs.python.org/zh-cn/3/library/sqlite3.html) - Python 标准库文档</Highlight>
- <Highlight color="green">[DB Browser for SQLite](https://sqlitebrowser.org/) - 可视化数据库管理工具</Highlight>
